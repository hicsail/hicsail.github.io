...
export const PROJECT_LIST: Array<ProjectInformation> = [
  {
    ...
    investigatorName: 'Dino Christenson',
    investigatorTitle: 'Associate Professor, CAS Political Science',
    investigatorLink: 'http://www.bu.edu/polisci/people/faculty/christenson/',
  ...
  },
  {
    ...
    investigatorName: 'Belinda Borrelli',
    investigatorTitle: 'Professor, SDM',
    investigatorLink: 'https://www.bu.edu/dental/profile/belinda-borrelli/',
  ...
  },
  {
    ...
    investigatorName: 'Mary Slavin',
    investigatorTitle: 'Research Assistant Professor, SPH',
    investigatorLink: 'https://www.bu.edu/sph/profile/mary-slavin',
    interns: '',
  },
  /*{ 'icons': ['shopping-cart'],
  ...
  },*/
  {
    ...
    investigatorName: 'Douglas Densmore',
    investigatorTitle: 'Associate Professor, ENG ECE',
    investigatorLink: 'http://cidarlab.org/doug-densmore',
    interns: '',
  },
  {
    icons: ['eye'],
    ...
    investigatorName: 'Sudha Arunachalam',
    investigatorTitle: 'Assistant Professor, SAR',
    investigatorLink: 'http://blogs.bu.edu/sarunach',
    interns: '',
  },
  {
    ...
    investigatorName: 'Cathie Jo Martin',
    investigatorTitle: 'Professor, CAS Political Science',
    investigatorLink: 'https://www.bu.edu/polisci/people/faculty/martin',
    interns: '',
  },
  //   {
  //     icons: ['bolt', 'plug'],
  ...
  //     investigatorName: 'Michael Caramanis',
  //     investigatorTitle: '',
  //     investigatorLink: 'http://www.bu.edu/pcms/caramanis/',
  //     investigators:
  //       '/">Michael Caramanis</a>, Prof. &amp; <a href="http://www.bu.edu/eng/profile/pablo-a-ruiz-phd/">Pablo Ruiz</a>, Research Assoc. Prof., ENG',
  //     interns: '',
  //   },
  //   /*{ 'icons': ['users', 'lock'],
  ...
  //     investigatorLink: '',
  //     investigators:
  //       'href="https://www.boston.gov/">City of Boston</a>, <a href="http://www.bostonwomensworkforcecouncil.com/">BWWC</a>, <a href="http://www.honda-ri.com/">HRI</a>, and others',
  //     interns: '',
  //   },
];
