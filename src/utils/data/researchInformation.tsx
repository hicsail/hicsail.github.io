...
export const ONGOINGRESEARCH_LIST: Array<ResearchInformation> = [
  ...
  {
    title: 'NLP',
    titleDescription: 'Natural Language Processing for Political Science',
    description:
    ...
    pi: (
      <>
        ...
        <Text as="span">Professor of Political Science</Text>
      </>
    ),
  },
  {
...
export const PASTRESEARCH_LIST: Array<ResearchInformation> = [
  {
    ...
    pi: (
      <>
        <Link
          href="https://nyulangone.org/doctors/1720187511/devin-mann"
          color="#567dbd"
        >
          Dr.Devin Mann,{' '}
        </Link>
        <Text as="span">Associate Professor of Medicine</Text>
      </>
    ),
  },
  {
    title: 'DASH',
    titleDescription: 'Dietary Approaches to Stopping Hypertension',
    description:
