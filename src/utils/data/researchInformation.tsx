...
export const ONGOINGRESEARCH_LIST: Array<ResearchInformation> = [
  {
    ...
    popTitle: 'COVID - Clinical Testing Lab',
    description:
  ...
  },
  {
    ...
    popTitle: 'Web MPC - Secure Compensation Analytics for the City of Boston',
    description:
  ...
  },
  {
    ...
    popTitle: 'NLP - Natural Language Processing for Political Science',
    description:
  ...
  },
  {
    ...
    popTitle: 'Noise Score - Describe and Visualize Your Daily Soundscape',
    description:
...
export const PASTRESEARCH_LIST: Array<ResearchInformation> = [
  {
    title: 'Hey Charlie;',
    popTitle: 'Hey Charlie - Combating opioid addiction',
    description:
    ...
    href: '../../../img/research/charlie.jpg',
  },
  {
    title: 'DASH; PI – Dr.Devin Mann, Associate Professor of Medicine ',
    popTitle: 'DASH - Dietary Approaches to Stopping Hypertension',
    description:
